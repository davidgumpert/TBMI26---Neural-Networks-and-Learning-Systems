...
XTrain = [XBins{1}(1:15, :); XBins{1}(400:425, :); XBins{1}(800:825, :)];
LTrain = [LBins{1}(1:15, :); LBins{1}(400:425, :); LBins{1}(800:825, :)];
DTrain = [DBins{1}(1:15, :); DBins{1}(400:425, :); DBins{1}(800:825, :)];
XTest  = XBins{2};
LTest  = LBins{2};
DTest = DBins{2};
...
numHidden     = 6;     % Change this, number of hidden neurons 
numIterations = 5000;   % Change this, number of iterations (epochs)
learningRate  = 0.04; % Change this, your learning rate
[a, b] = size(XTrain);
c = unique(LTrain);
e = size(c);
W0 = (normrnd(0,1,numHidden + 1, e(1)))/100; % Initialize your weight matrix W
V0 =(normrnd(0,1,b, numHidden))/100; % Initialize your weight matrix V
